  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center py-10 px-4 md:px-0">
        <Image className="pb-5 w-10 " src="/nikelogo.png" width={40} height={10} alt="Logo"  />
        <h2 className="uppercase text-center font-bold pb-5">
          BECOME A NIKE MEMBER
        </h2>
        <p className="w-full max-w-md text-center text-text-secondary-gray pb-5">
        ...
        <form action="" className="flex flex-col w-full max-w-md">
          ...
          <input className="w-full border-[#E5E5E5] rounded-md mb-2 px-4 py-3 border-[2px] placeholder:text-text-secondary-gray" type="text" placeholder="Date of Birth" />
          <p className="pb-3 text-text-secondary-gray text-sm text-center">
            Get a Nike Member Reward every year on your Birthday.
          </p>
          <select className="w-full border-[#E5E5E5] rounded-md mb-2 px-4 py-3 border-[2px] placeholder:text-text-secondary-gray" name="" id="">
          ...
          <div className="flex gap-5 mt-1">
            <div className="border-[#E5E5E5] rounded-md py-4 border-[2px] w-1/2 text-center text-text-secondary-gray">Male</div>
            <div className="border-[#E5E5E5] rounded-md py-4 border-[2px] w-1/2 text-center text-text-secondary-gray">Female</div>
          </div>
          ...
          <p className="text-text-secondary-gray text-center pb-6">
            By creating an account, you agree to Nike&apos;s <Link className="underline" href="#">Privacy Policy</Link> and <Link className="underline" href="#">Terms of Use</Link>.
          </p>
          <Button text="JOIN US" classNames="rounded-sm py-3" />
          <p className="text-center">
            <span className="text-text-secondary-gray">Already a Member? </span><span className="underline">Join Us.</span>
          </p>
        </form>
      </div>
      <Footer />
